...
public class SystemPerformanceManager
{
	...
	public SystemPerformanceManager()
	{
		...
		// creating instances for the scheduler
	...
	{
		// Telemetry Methods invoked from SystemCpuUtilTask and SystemMemUtilTask
	...
	{
		// Starting the system performance task at a fixed rate
		if(! this.isStarted){
	...
	{
		// Shutting down the system performance manager
